...
class ProfileEditForm(FlaskForm):
  ...
  password = PasswordField(name = 'Change Password', validators = [DataRequired(), Length(8, 20), EqualTo('confirm', 'Passwords do not match')])
  confirm  = PasswordField(name = 'Confirm New Password', validators = [DataRequired(), Length(1, 20)])
